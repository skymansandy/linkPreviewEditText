package `in`.codeshuffle.examplelinkpreview.ui.fragment.webpagescreen

import `in`.codeshuffle.examplelinkpreview.databinding.FragmentWebpageBinding
import `in`.codeshuffle.examplelinkpreview.util.AppConstants.URLs
